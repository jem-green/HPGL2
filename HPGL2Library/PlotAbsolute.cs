                    ...
                    do
                    {
                        ...
                        if (_hpgl2.Match(','))
                        {
                            ...
                            if (_hpgl2.Pen.Status == Pen.PenStatus.Down)
                            {
                                ...
                                _hpgl2.Logger.LogDebug(_name + "Line " + _hpgl2.Current.ToString() + " to " + coOrd.ToString());
                                _hpgl2.Lines.Add(line);
                            }
                            else
                            {
                                _hpgl2.Logger.LogDebug(_name + "Move " + _hpgl2.Current.ToString() + " to " + coOrd.ToString());
                            }
